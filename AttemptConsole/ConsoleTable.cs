...
namespace AttemptConsole
{
    public class ConsoleTable
    {
        ...
        public void Write(Format format = AttemptConsole.Format.Default)
        {
            switch (format)
            {
                case AttemptConsole.Format.Default:
                    Console.WriteLine(ToString());
                    break;
                case AttemptConsole.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case AttemptConsole.Format.Alternative:
                    Console.WriteLine(ToStringAlternative());
                    break;
                case AttemptConsole.Format.Minimal:
